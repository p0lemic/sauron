    ...
    public function getConfigTreeBuilder(): TreeBuilder
    {
        ...
        $root
            ->children()
                ...
                ->end()
                ->booleanNode('instrument_routing')
                    ->defaultTrue()
                    ->info('Create a "routing" span covering kernel.request → kernel.controller (security, route matching).')
                ->end()
                ->booleanNode('instrument_view')
                    ->defaultTrue()
                    ->info('Create a "view" span when the controller returns a non-Response (template rendering).')
                ->end()
